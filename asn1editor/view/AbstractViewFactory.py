...
class AbstractViewFactory:  # pragma: no cover
    def get_number_view(self, name_and_tag: Tuple[str, str], optional: bool, minimum: int, maximum: int, float_: bool) -> Tuple[AbstractView, ValueInterface,
                                                                                                                                OptionalInterface]:
    ...
    def get_string_view(self, name_and_tag: Tuple[str, str], string_type: str, optional: bool, minimum: int, maximum: int) -> Tuple[
    ...
    def get_bitstring_view(self, name_and_tag: Tuple[str, str], number_of_bits: int, named_bits: List[Tuple[int, str]], optional: bool) -> Tuple[
        ChoiceView, BitstringInterface,
        OptionalInterface]:
        raise NotImplementedError
